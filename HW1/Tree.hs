...
-- | Retrieve the value of a tree's root value
...
isBST :: Tree -> Bool
isBST (Leaf i)     = True
isBST (Node i l r) = (isBST l) && (getVal l < i) && (i < getVal r) && (isBST r)
...
--
inBST :: Int -> Tree -> Bool
inBST val (Leaf i)     = val == i
inBST val (Node i l r) = val == i || inBST val l || inBST val r
